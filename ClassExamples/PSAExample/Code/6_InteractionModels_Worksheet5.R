...
###########################################################################
#################LOG PSA AND Interactin with SVI ANALYSIS##################################
###########################################################################

####Run a linear model just to orient us using standard methods
fullmodel <-lm(lpsa ~ cavol + svi + cavolsviint , data=psaclean2)

sink("Output/CavolSVIIntOutput.txt")
print(fullmodel)
...
write_csv(as.data.frame(out_mat), "Output/bayes-est-worksheet5-cavolmodel.csv")

###########################################################################
#################LOG PSA AND REMOVE Interaction for cavol ANALYSIS##################################
###########################################################################
...
write_csv(as.data.frame(out_mat), "Output/bayes-est-worksheet5-cavolnointmodel.csv")

###########################################################################
#################LOG PSA AND Interaction with SVI ANALYSIS##################################
###########################################################################

####Run a linear model just to orient us using standard methods
fullmodel <-lm(lpsa ~ wt + svi + wtsviint , data=psaclean2)

sink("Output/WTSVIIntOutput.txt")
print(fullmodel)
summary.lm(fullmodel)
confint(fullmodel)
sink()
...
write_csv(as.data.frame(out_mat), "Output/bayes-est-worksheet5-wtintmodel.csv")

###########################################################################
#################LOG PSA AND REMOVE Interaction for weight ANALYSIS##################################
###########################################################################
