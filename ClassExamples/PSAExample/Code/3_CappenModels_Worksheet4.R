###########################################################
## Program Name: CappenModels_Worksheet4.R       ##
## Purpose: Investigate confounding for cappen         ##
...
###########################################################################
#################LOG PSA AND cappen and cavol ANALYSIS##################################
###########################################################################
...
write_csv(as.data.frame(out_mat), "Output/bayes-est-worksheet4-cappencavolmodel.csv")
