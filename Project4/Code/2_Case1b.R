...
saveRDS(nSim, "DataRaw/nSim1b.rda")
saveRDS(coefEstsBS, "DataRaw/coefEstsBS1b.rda")
saveRDS(coefEstsAIC, "DataRaw/coefEstsAIC1b.rda")
saveRDS(coefEstsBIC, "DataRaw/coefEstsBIC1b.rda")
saveRDS(coefEstsLASSOCV, "DataRaw/coefEstsLASSOCV1b.rda")
saveRDS(coefEstsLASSOFIX, "DataRaw/coefEstsLASSOFIX1b.rda")
saveRDS(coefEstsENCV, "DataRaw/coefEstsENCV1b.rda")
saveRDS(coefEstsENFIX, "DataRaw/coefEstsENFIX1b.rda")