...
modelDF2a <- cbind("stat" = rownames(modelDF2a), 
                   data.frame(modelDF2a, row.names = NULL))

modelDF2a$stat <- c("Total TPR", "FPR", "FDR", "Type I Error", "Type 2 Error")
...
coefDF2a <- cbind("stat" = rownames(coefDF2a), 
                  data.frame(coefDF2a, row.names = NULL))

coefDF2a$stat <- c("Bias", "95\\% CI", "TPR",
                   "Bias", "95\\% CI", "TPR",
                   "Bias", "95\\% CI", "TPR",
                   "Bias", "95\\% CI", "TPR",
                   "Bias", "95\\% CI", "TPR")

colnames(modelDF2a) <- colnames(coefDF2a)
