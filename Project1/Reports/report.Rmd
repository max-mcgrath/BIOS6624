...
<!-- The missingness is described in table ??? -->
...
associated with 0.682 times lower difference in HIV copies in an mL of blood following two 
...
implying there is a negative effect of hard drug use on HAART. We also see
...
between individuals who use hard drugs and those who do not.
